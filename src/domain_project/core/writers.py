...
Usage::
    ...
    from domain_project.core.writers import write_iceberg, write_parquet
    write_iceberg(df, "glue_catalog.curated.daily_sales", mode="append")
...
def write_iceberg(
    ...
    table:
        ...
        (e.g. ``glue_catalog.curated.daily_sales``).
    mode:
