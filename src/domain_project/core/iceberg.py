...
Usage::
    ...
    from domain_project.core.iceberg import (
        create_table_if_not_exists,
        expire_snapshots,
        rewrite_data_files,
    )
    create_table_if_not_exists(spark, "glue_catalog.curated.orders", schema_ddl)
"""
...
def create_table_if_not_exists(
    ...
    table:
        Fully-qualified table name (e.g. ``glue_catalog.curated.orders``).
    schema_ddl:
