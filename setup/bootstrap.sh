...
setup_env_file() {
    ...
    local domain_abbr domain_name aws_region
...
# Source: domain.json (${domain_name})
ENV=local
...
# ${domain_abbr^^}_RAW_BUCKET=${domain_abbr}-raw-local
# ${domain_abbr^^}_CURATED_BUCKET=${domain_abbr}-curated-local
# ${domain_abbr^^}_ARTIFACTS_BUCKET=${domain_abbr}-artifacts-local
EOF
